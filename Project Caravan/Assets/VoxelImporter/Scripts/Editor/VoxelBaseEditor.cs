    ...
    public abstract class VoxelBaseEditor : Editor
    {
        ...
        protected void InspectorGUI_ConfigureDisable()
        {
            if (baseTarget.disableData != null)
            {
                ...
                if (GUILayout.Button("Configure Disable Face", baseTarget.edit_configureMode == VoxelBase.Edit_ConfigureMode.Disable ? guiStyleBoldActiveButton : GUI.skin.button))
                {
